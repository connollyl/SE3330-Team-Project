...
namespace RestaurantKiosk.Tests
{
   ...
   public class AdminControllerTests
   {
      ...
      public void undoUpdateCommandTest()
      {
         AdminController ac = new AdminController();
         ac.addMenuItem(100, "DESC", "1111", 4.0f, 3.0f, "Meals");
         ac.history.undo(ac.restaurantMenu);
      ...
      public void redoUpdateCommandTest()
      {
         AdminController ac = new AdminController();
         ac.addMenuItem(100, "DESC", "1111", 4.0f, 3.0f, "Meals");
         ac.history.done_commands.Peek().see_details();
         ac.history.undo(ac.restaurantMenu);
         ac.history.redo(ac.restaurantMenu);
         int index = ac.loadRestaurantMenu().Count;
         Assert.IsTrue(ac.loadRestaurantMenu()[index - 1].nameAtt.Equals("1111"));
      }
      ...
      {
         AdminController ac = new AdminController();
         AdminHistory hist = ac.getHistory();
         Assert.AreNotEqual(hist, null);
